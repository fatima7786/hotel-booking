...
const RoomDetail = ()=>
{
    ...
    <div className='py-28 md:py-35 px-4 md:px-16 lg:px-24 xl:px-32'>
        ...
        <div className='flex flex-col md:flex-row items-start md:items-center gap-2'>
            ...
            <p className='text-sx font-inter px-1.5 px-3 text-white bg-orange
            -500 rounded-full'> 20% OFF</p>
        </div>
        {/*Room Rating*/}
        ...
        {/*Room Highlights*/}
        <div className='flex flex-col md:flex-row md:justifying-between mt-10'>
        ...
        justifying-between bg-white shadow-[0px_opx_20px_rgba(0,0,0,0.15)]p-6
        rounded-xl mx-auto mt-16max-w-6xl'>
...
<div className='max-w-3xl border-y border-gray-300 my-15 py-10 text-gray-500'>
    <p> Guests will be allocated to the ground floor according to the  availability.
        you get a comfortable two bedroom apartment that has a true city feeling. The price 
        quoted is for guest, at the guest slot please mark the number of guests to get 
        the exact price for groups. The ground floor will be allocated according to the Availability
